...
self.addEventListener('message', e => {
  ...
  const {player, tempo, calorias, fator} = e.data;
  self.registration.showNotification('GymBet — Nova ida! 💪', {
    body: player+' registrou '+tempo+'min · '+calorias+'kcal · ⚡'+fator,
    icon: './icon.svg',
    badge: './icon.svg',
    vibrate: [200,100,200],
